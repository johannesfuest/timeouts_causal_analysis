...
for (i in 1:9) {
  ...
  df_list[[i]]$TimeoutCalledInitially <- TRUE
  preds_1 <- predict(model_2, df_list[[i]], type = "response")
  df_list[[i]]$TimeoutCalledInitially <- FALSE
  preds_0 <- predict(model_2, df_list[[i]], type = "response")
