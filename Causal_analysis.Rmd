...
Note that we fit separate propensity scores within each stratum here and compare the log likelihood to the propensity score fit on the full dataset. We note that the propensity score  
```{r}
